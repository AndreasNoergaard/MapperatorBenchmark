...
{
    public class AutomapperCtorMapper : IObjectToObjectMapper
    {
    ...
    public class AutomapperFlatteningMapper : IObjectToObjectMapper
	{
	...
	public class ManualFlatteningMapper : IObjectToObjectMapper
	{
		private ModelObject _source;
		...
		public void Map()
		{
			var destination = MapHelper(_source);
		}

	    public static ModelDto MapHelper(ModelObject source)
	    {
	        return new ModelDto
	        {
    ...
    public class MapperatorFlatteningMapperOneLayered : IObjectToObjectMapper
    {
        private ModelObject _source;

        public string Name
        {
            get { return "Mapperator one-Layered"; }
        }
        public void Initialize()
        {
            _source = new ModelObject
        ...
        public void Map()
        {
            ModelObjectToModelDtoMapper.Instance.Map(_source);
        }
    }
	public class Model1
	{
